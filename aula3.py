...
I1_path = os.path.join(cf,'ImagensAulas','Mamography.pgm') # endereco da imagem
I1 = imageio.imread(I1_path)
...
fig = plt.gcf()
fig.canvas.set_window_title('Mamo Figure')
plt.subplot(121)
plt.imshow(I1)
plt.title('Original')
plt.set_cmap('gray')
