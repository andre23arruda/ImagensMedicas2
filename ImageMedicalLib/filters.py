...
def ffilter(image,f1,f2=0):
    ...
    INPUTS:
        ...
        f2: frequencia minima (Default = 0). Se mudar, teremos um filtro passa faixa
...
def LeeFilter(image,kernelLength,show = False):
    ...
    if show:
        info.showImageStyle(1,2,{'I1':changeFormat.im2uint8(image),
...
def meanFilterFast(image,kernelLength):
    ...
    INPUTS:
        ...
        kernelLength: tamanho da máscara de filtragem
